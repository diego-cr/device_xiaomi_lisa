...
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,$(LOCAL_PATH)/configs/audio/sku_lahaina,$(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_lahaina) \
    $(call find-copy-subdir-files,*,$(LOCAL_PATH)/configs/audio/sku_shima,$(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_shima) \
    $(call find-copy-subdir-files,*,$(LOCAL_PATH)/configs/audio/sku_yupik,$(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_yupik)
